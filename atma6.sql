...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2016 at 12:02 AM
...
(1, 1, 1, 'project1', '2016-01-14', '2016-04-15', NULL, NULL, 'completed', 1),
...
INSERT INTO `p_vol` (`p_vol_id`, `hours`, `weeks`, `p_uid`, `p_pid`) VALUES
(23, 7, 1, 3, 1),
(24, 6, 1, 5, 3),
(25, 101, 5, 6, 4),
(26, 6, 1, 4, 2);
...
ALTER TABLE `activity`
  ADD PRIMARY KEY (`aid`),
  ADD KEY `a_paid_idx` (`a_paid`),
  ADD KEY `fk_sid_idx` (`a_sid`);
...
ALTER TABLE `projects`
  ADD PRIMARY KEY (`pid`),
  ADD KEY `fk_aid_idx` (`aid`),
  ADD KEY `fk_ngoid_idx` (`ngo_id`),
  ADD KEY `fk_odid_idx` (`odid`);

--
-- Indexes for table `p_vol`
--
ALTER TABLE `p_vol`
  ADD PRIMARY KEY (`p_vol_id`,`p_pid`),
  ADD KEY `fk_ppid_idx` (`p_pid`),
  ADD KEY `fk_puid_idx` (`p_uid`);
