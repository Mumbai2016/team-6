      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Volunteer Application</span></a>
            </div>
        ...
        <!-- page content -->
         <div class="right_col" role="main">
          ...
          <br />
		  <center><h1> New Volunteer Application</h1></center>
					</br>
					<form action="submit_volunteer.php" method="POST">
					<div class="form-group">
                       
					   Name: <input class="form-control" type="text" name="name" value=""> <!---the php script shows how to keep the values in the input fields when the user hits the submit button--->
   
   <br><br>
   
   Country: <input  class="form-control" type="text" name="country" value=""> 
